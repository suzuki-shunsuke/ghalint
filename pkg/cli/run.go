...
func (r *Runner) Run(ctx context.Context, cmd *cli.Command, logger *slogutil.Logger) error {
	...
	return ctrl.Run(ctx, logger.Logger, cmd.String("config")) //nolint:wrapcheck
}
